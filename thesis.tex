...
%%%%%%%%%%HEADERS%%%%%%%%%%%%%
\usepackage{fancyhdr}
%%%%%%%%%%%%%%%%NOT USED I DON'T REALLY KNOW WHAT IT DOES%%%%%%%%%%%%%%%%%
\pagestyle{fancy}
...
%to have a custom header for the introduction first page NOT USED
...
%to personalize the section name im the \rightmark call 
\renewcommand{\sectionmark}[1]{%
 \markright{\MakeUppercase{#1}}}%
%to recover normal header style after the introduction, adding alternation of chapter number and section name
\fancypagestyle{landau}{
    \fancyhead[CE]{\small \bfseries{CHAPTER} \thesection}
    \fancyhead[CO]{\small \bfseries\rightmark}
    \fancyhead[L]{} 
    \fancyhead[LE,RO]{\thepage}  
    %\renewcommand{\headrulewidth}{0pt}  
}
...
%to manipulate the TOC (indentations, dot separations etc) 
\usepackage{tocloft} 
\renewcommand{\cftdotsep}{1} % Separation of dots in TOC
\setlength{\cftbeforesecskip}{15pt}    % Space before a section entry
\setlength{\cftbeforesubsecskip}{5pt} % Space before a subsection entry
%\setlength{\cftsubsecnumwidth}{2em}  % Space between subsection number and name
\setlength{\cftsecindent}{0em}  % Adjust indentation of sections
\renewcommand{\cftsecfont}{\bfseries\large}        % Make section titles bold in TOC
\renewcommand{\cftsubsecfont}{\bfseries}     % Make subsection titles bold in TOC
\renewcommand{\cftsecpagefont}{\bfseries}        % Make section page numbers bold
\renewcommand{\cftsubsecpagefont}{\bfseries}     % Make subsection page numbers bold
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%introduction
%to change the introduction header
\pagestyle{intro2}
%to add the introductionto the toc
\addcontentsline{toc}{section}{\hspace{10mm}Introduction}
%White page after toc
\clearpage
\newpage
\thispagestyle{empty}
\
...
\pagestyle{landau}
%CHAPTERS
%At the start of each one is necessary to insert \newpage \phantom \thispagestyle{empty}
%chapter1
